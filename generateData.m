...
inputS{1} = spikeX1(1:0.6*length(t));
inputS{2} = spikeX1(0.6*length(t)+1:0.7*length(t));
inputS{3} = spikeX1(0.7*length(t)+1:length(t));
...
outputYs{1, 1} = spikeYs1(1:0.6*length(t));
outputYs{1, 2} = spikeYs1(0.6*length(t)+1:0.7*length(t));
outputYs{1, 3} = spikeYs1(0.7*length(t)+1:length(t));

outputYs{2, 1} = spikeYs2(1:0.6*length(t));
outputYs{2, 2} = spikeYs2(0.6*length(t)+1:0.7*length(t));
outputYs{2, 3} = spikeYs2(0.7*length(t)+1:length(t));

outputYs{3, 1} = spikeYs3(1:0.6*length(t));
outputYs{3, 2} = spikeYs3(0.6*length(t)+1:0.7*length(t));
outputYs{3, 3} = spikeYs3(0.7*length(t)+1:length(t));
...
outputLambdaS{1, 1} = lambdaYs1(1:0.6*length(t));
outputLambdaS{1, 2} = lambdaYs1(0.6*length(t)+1:0.7*length(t));
outputLambdaS{1, 3} = lambdaYs1(0.7*length(t)+1:length(t));

outputLambdaS{2, 1} = lambdaYs2(1:0.6*length(t));
outputLambdaS{2, 2} = lambdaYs2(0.6*length(t)+1:0.7*length(t));
outputLambdaS{2, 3} = lambdaYs2(0.7*length(t)+1:length(t));

outputLambdaS{3, 1} = lambdaYs3(1:0.6*length(t));
outputLambdaS{3, 2} = lambdaYs3(0.6*length(t)+1:0.7*length(t));
outputLambdaS{3, 3} = lambdaYs3(0.7*length(t)+1:length(t));
